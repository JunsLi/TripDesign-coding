...
function [Convergence_curve2,Ave2,Sd2]=EO(Particles_no,Max_iter,lb,ub,dim,fobj,Run_no)
disp('EO is now tackling your problem')
for irun=1:Run_no
...
C_pool=[Ceq1; Ceq2; Ceq3; Ceq4; Ceq_ave];                     % Equilibrium pool
 ...
 t=(1-Iter/Max_iter)^(a2*Iter/Max_iter);                      % Eq (9)
    ...
    for i=1:Particles_no
       ...
       Iter=Iter+1;  
       Convergence_curve2(Iter)=Ceq1_fit; 
